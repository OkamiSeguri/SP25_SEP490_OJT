    ...
    : base(options) { }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OJTFeedback>()
                .HasOne(fb => fb.OJTProgram)
                .WithMany(p => p.OJTFeedbacks)
                .HasForeignKey(fb => fb.ProgramId)
                .OnDelete(DeleteBehavior.NoAction);

            modelBuilder.Entity<OJTFeedback>()
                .HasOne(fb => fb.OJTRegistration)
                .WithMany(reg => reg.OJTFeedbacks)
            ...
            modelBuilder.Entity<OJTResult>()
                .HasOne(r => r.OJTRegistration)
                .WithMany(reg => reg.OJTResults)
                .HasForeignKey(r => r.OJTId)
                .OnDelete(DeleteBehavior.NoAction);
        }
