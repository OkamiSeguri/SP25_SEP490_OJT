        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPassed = table.Column<int>(type: "int", nullable: true, computedColumnSql: "CASE WHEN Grade >= 5.0 THEN 1 ELSE 0 END")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Comments = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    OJTRegistrationOJTId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
